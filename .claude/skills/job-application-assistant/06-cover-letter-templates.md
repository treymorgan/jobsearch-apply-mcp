...
1. Run `tectonic -X compile cover_<company>_<role>.tex`
...
- Adjust closing to local convention (US standard: "Sincerely," or "Best regards,")

## Checklist Before Finalizing
- [ ] No em-dashes (use commas or periods instead)
- [ ] No cliches or empty filler
- [ ] Every claim backed by specific example
- [ ] Forward-looking framing: emphasizes tasks you'll solve, not just past duties
