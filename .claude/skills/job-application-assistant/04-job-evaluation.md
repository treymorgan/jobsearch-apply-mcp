...
<!-- SETUP: Skill match areas, constraints, logistics, salary floor and career goals are personalized by running /setup. -->
...
<!-- Filled in by /setup. Keep these field-neutral and based only on the candidate's real profile. -->
**Strong match areas:** [Primary skill areas, domains, tools, leadership scope or functional strengths]
**Moderate match areas:** [Adjacent skill areas, transferable tools, related domains or developing strengths]
**Weak match areas:** [Areas where the candidate lacks evidence, should not overclaim or would need significant learning]

### 2. Experience Match (0-100)
Does work history align with what they're looking for? Match on the function and nature of the work performed, not the literal job title - for example, two differently titled roles can still be functionally identical when their day-to-day work is the same.
...
<!-- Filled in by /setup. Describe experience bands without naming any private employer unless the user chooses to include one. -->
**Strong:** [Directly relevant roles, domains, responsibilities, scale or achievements]
**Moderate:** [Related roles, adjacent industries, transferable responsibilities or partial matches]
**Entry-level:** [Role types or domains where the candidate has little or no evidence]
...
**Red flags to research:** Department disorganization, work dominated by tasks the candidate finds draining, poor chemistry with leadership, culture mismatches. Check reviews, media coverage, LinkedIn connections, and network contacts for insider perspective.

### 4. Location & Logistics (Pass/Fail + Notes)
Use the candidate's configured constraints from `01-candidate-profile.md`. Judge this from the posting's own text, never from a portal's remote filter or its search-result location string, both are unreliable and routinely label remote roles with a city.

- Roles inside the candidate's configured commutable area: PASS, regardless of onsite, hybrid or remote mode, unless another configured constraint says otherwise.
- Roles outside the configured commutable area: PASS only if the posting clearly supports the candidate's configured remote, relocation and travel constraints.
- Remote roles restricted to countries, regions, states or provinces that exclude the candidate: FAIL.
- Roles requiring relocation the candidate has not configured as acceptable: FAIL.
- Roles below the candidate's configured salary floor or compensation minimum: FAIL when compensation is stated clearly enough to compare.
- Remote status, work location or travel requirements not stated anywhere in the posting: FLAG, discuss with the user, never assume remote.
- Frequent travel, unusual schedules, contract terms, visa limitations or start-date constraints: FLAG unless already covered by the candidate's configured preferences.
...
<!-- Filled in by /setup. Keep career goals specific to the candidate, but avoid publishing private details in the public template. -->
**Career goals:**
- [Long-term role, scope, function, industry or impact goal]
- [Preferred growth path]
- [Preferred ownership or leadership scope]

**Motivation filter:** Evaluate not just whether you *can* do the tasks, but whether the tasks will *energize* you. Consider:
- Tasks that energize: [Configured energizing tasks, problem types, stakeholders or work modes]
- Tasks that drain: [Configured draining tasks, environments, responsibilities or work modes]
- Non-task factors: leadership style, department culture, company values, degree of autonomy, travel, schedule and location

**Life situation alignment:** Consider personal constraints from `01-candidate-profile.md`:
- **Security:** [Current search urgency, risk tolerance and compensation floor]
- **Flexibility:** [Configured location, work mode, relocation, schedule and travel constraints]
- **Professional development:** [Skills, scope, credentials or experience the candidate wants to build]
