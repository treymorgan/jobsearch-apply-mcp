...
The tool reads a `salary_data.json` file in the repo root containing company salary benchmarks. It uses fuzzy matching to find companies by name, handling legal suffixes (Inc., LLC, Corp.) and common spelling variations.
...
- The fuzzy matcher handles company name variations: legal suffixes, punctuation, and partial matches.
